...
@Entity
@Table(name="farmer_information_with_veg")
...
public String toString() {
	return "FarmerInfo [phoneNumber=" + phoneNumber + ", area=" + area + ", vegetableQuantity=" + vegetableQuantity
			+ ", transportName=" + transportName + ", distanceFromMandi=" + distanceFromMandi + ", farmerVisitingCount="
			+ farmerVisitingCount + ", sellingArea=" + sellingArea + ", nameOfMandi=" + nameOfMandi
			+ ", varietyOfVegetables=" + varietyOfVegetables + ", amountOfCommision=" + amountOfCommision + ", quest1="
			+ quest1 + ", quest2=" + quest2 + ", quest3=" + quest3 + ", quest4=" + quest4 + "]";
}
