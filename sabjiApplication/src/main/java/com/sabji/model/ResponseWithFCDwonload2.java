...
public class ResponseWithFCDwonload2 {
	public static ResponseEntity<Object> generateResponse(String message, HttpStatus status, String customcode,String filebytes) {
