...
public class ResponseWithFCDwonload {
	public static ResponseEntity<Object> generateResponse(String message, HttpStatus status, String customcode,byte[] filebytes) {
